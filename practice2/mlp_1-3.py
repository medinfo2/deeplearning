...
def main(description, gpu, output):
	...
	rtarget = numpy.zeros(mnist.target.shape, numpy.int32)
	for i in xrange(10):
		rtarget += (mnist.target == i) * (9 - i)
	data_train, data_test, target_train, target_test = train_test_split(mnist.data, rtarget)
